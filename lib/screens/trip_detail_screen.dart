...
class TripDetailScreen extends StatelessWidget {
 ...
 TripDetailScreen({required this.manageFavorite,this.isFavorite});
 ...
 Widget buildListViewContainer(Widget child){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(selectedTrip.title),centerTitle: true,
      ),
      body: SingleChildScrollView(
        child: Column(
          children: [
           ...
           SizedBox(height: 10,),
           buildSectionTitle('الانشطة', context),
            ...
            SizedBox(height: 10,),
            buildSectionTitle('البرنامج اليومي', context),
            buildListViewContainer(
              ListView.builder(
